    ...
    <form action="{{ route('admin.companies.update', $company) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <div class="mb-4">
                ...
                <div class="mb-2">
                    <img src="{{ Storage::url($company->logo) }}" alt="{{ $company->name }}" class="h-20 w-auto object-contain border rounded p-2">
                </div>
                <input type="file" name="logo" accept="image/*"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg">
                <p class="mt-1 text-sm text-gray-500">Upload new logo to replace current</p>
            </div>
